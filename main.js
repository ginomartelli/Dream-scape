...
const buttonClimb = document.getElementById("buttonClimb");
buttonClimb.addEventListener('click', async function() {
    loading.classList.remove("hide");
    scene = await createScene2(engine);
    game_ready = true;
    is_playing = true;
    engine.runRenderLoop(() => {
        scene.render();
...
function startTimer2(looseSound) {
    timerDiv.classList.remove("hidden");
    timer = "60:01";
    timerInterval = setInterval(() => {
        if (is_playing && game_ready && !in_pause) {
...
async function createScene2(engine) {
    var scene = new BABYLON.Scene(engine);
    var moonLight = new BABYLON.DirectionalLight("moonLight", new BABYLON.Vector3(-1, -1, -1), scene);
    moonLight.diffuse = new BABYLON.Color3(1, 1, 1); 
    moonLight.specular = new BABYLON.Color3(1,1,1);
    ...
    var islandPositions = [
        { position: new BABYLON.Vector3(0, 0, 0), scale: 1 }, //1ST
        { position: new BABYLON.Vector3(0, 0, -100), scale: 1 }, //portal island
        { position: new BABYLON.Vector3(100, 1000, 100), scale: 0.6 }, //final island
        //island orbes : 
        { position: new BABYLON.Vector3(6 ,98,5), scale: 0.1 }, 
        { position: new BABYLON.Vector3(5,198,-5), scale: 0.1 }, 
        { position: new BABYLON.Vector3(5,298,10,3), scale: 0.1 }, 
        { position: new BABYLON.Vector3(-8,398,-8), scale: 0.1 }, 
        { position: new BABYLON.Vector3(-3,498,13),scale: 0.1 }, 
        { position: new BABYLON.Vector3(-5, 600-2, 11), scale: 0.1 }, 
        { position: new BABYLON.Vector3(3,700-2,7), scale: 0.1 }, 
        { position: new BABYLON.Vector3(21,800-2,-38), scale: 0.1 }, 
        { position: new BABYLON.Vector3(7,900-2,-16), scale: 0.1 }, 
         //parcours islands:
        { position: new BABYLON.Vector3(0, 2, -8), scale: 0.1 },  //parcours islands:
        { position: new BABYLON.Vector3(0, 5, -7), scale: 0.1 },
        { position: new BABYLON.Vector3(1, 8, 1), scale: 0.1 },
        { position: new BABYLON.Vector3(3, 11, 0), scale: 0.1 },
        { position: new BABYLON.Vector3(5, 14, -2), scale: 0.1 },
        { position: new BABYLON.Vector3(7, 17, 1), scale: 0.1 },
        { position: new BABYLON.Vector3(6, 20, 4), scale: 0.1 },
        { position: new BABYLON.Vector3(9, 23, 6), scale: 0.1 },
        { position: new BABYLON.Vector3(12, 26, 9), scale: 0.1 },
        { position: new BABYLON.Vector3(15, 29, 11), scale: 0.1 },
        { position: new BABYLON.Vector3(18, 32, 12), scale: 0.1 },
        { position: new BABYLON.Vector3(21, 35, 14), scale: 0.1 },
        { position: new BABYLON.Vector3(24, 38, 17), scale: 0.1 },
        { position: new BABYLON.Vector3(27, 41, 19), scale: 0.1 },
        { position: new BABYLON.Vector3(30, 45, 20), scale: 0.1 },
        { position: new BABYLON.Vector3(52, 66, 34), scale: 0.1 },
        { position: new BABYLON.Vector3(56, 69, 36), scale: 0.1 },
        { position: new BABYLON.Vector3(60, 72, 38), scale: 0.1 },
        { position: new BABYLON.Vector3(65, 75, 41), scale: 0.1 },
        { position: new BABYLON.Vector3(70, 79, 44), scale: 0.1 },
        { position: new BABYLON.Vector3(75, 83, 48), scale: 0.1 },
        { position: new BABYLON.Vector3(73, 86, 52), scale: 0.1 },
        { position: new BABYLON.Vector3(80, 89, 52), scale: 0.1 },
        { position: new BABYLON.Vector3(7, 286, 20), scale: 0.1 },
        { position: new BABYLON.Vector3(4, 340, -12), scale: 0.1 },
        { position: new BABYLON.Vector3(7, 343, -10), scale: 0.1 },
        {position : new BABYLON.Vector3(5, 347, -9), scale: 0.1 },
        { position: new BABYLON.Vector3(5, 350, -7), scale: 0.1 },
        { position: new BABYLON.Vector3(3, 353, -5), scale: 0.1 },
        { position: new BABYLON.Vector3(1, 356, -3), scale: 0.1 },
        { position: new BABYLON.Vector3(-2, 359, -1), scale: 0.1 },
        { position: new BABYLON.Vector3(-5, 362, -4), scale: 0.1 },
        { position: new BABYLON.Vector3(-6, 365, -6), scale: 0.1 },
        { position: new BABYLON.Vector3(-8, 368, -8), scale: 0.1 },
        { position: new BABYLON.Vector3(-6, 383, -8), scale: 0.1 },
        { position: new BABYLON.Vector3(6,695,6), scale: 0.1 }, 
        { position: new BABYLON.Vector3(21,750,-42), scale: 0.1 }, 
        //9
        { position: new BABYLON.Vector3(9,900,-16), scale: 0.05 }, 
        { position: new BABYLON.Vector3(12,904,-11), scale: 0.1 }, 
        { position: new BABYLON.Vector3(19.5,908,0.5), scale: 0.1 },
        { position: new BABYLON.Vector3(27,912,12), scale: 0.1 }, 
        { position: new BABYLON.Vector3(34.5,916,23.5), scale: 0.1 },
        { position: new BABYLON.Vector3(42,920,35), scale: 0.1 }, 
        { position: new BABYLON.Vector3(49.5,924,46.5), scale: 0.1 }, 
        { position: new BABYLON.Vector3(57,928,58), scale: 0.1 }, 
        { position: new BABYLON.Vector3(64.5,932,69.5), scale: 0.1 },
        { position: new BABYLON.Vector3(72,936,81), scale: 0.1 }, 
        {position : new BABYLON.Vector3(85,935,92), scale: 0.2 },
        { position: new BABYLON.Vector3(79.5,940,92.5), scale: 0.1 },
        {position : new BABYLON.Vector3(90.5,945,93.5), scale: 0.1 },
        { position: new BABYLON.Vector3(79.5,950,94.5), scale: 0.1 },
        { position: new BABYLON.Vector3(90.5,955,95.5), scale: 0.1 },
        { position: new BABYLON.Vector3(79.5,960,96.5), scale: 0.1 },
        { position: new BABYLON.Vector3(90.5,965,97.5), scale: 0.1 },
        { position: new BABYLON.Vector3(79.5,970,98.5), scale: 0.1 },
        { position: new BABYLON.Vector3(90.5,975,99.5), scale: 0.1 },
        { position: new BABYLON.Vector3(79.5,980,100.5), scale: 0.1 },
        { position: new BABYLON.Vector3(90.5,985,101.5), scale: 0.1 },
        { position: new BABYLON.Vector3(79.5,990,102.5), scale: 0.1 },
        { position: new BABYLON.Vector3(90.5,995,103.5), scale: 0.1 },
    ];
    var base_island = (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "island.glb", scene)).meshes[0];
    islandPositions.forEach((islandPosition, index) => {
        let island = base_island.clone("island" + index);
    ...
    ///////////////////////////// CREATE CKECKPOINTS
    // Afficher un message dans le menu des checkpoints
    const noCheckpointMsg = document.createElement("div");
    noCheckpointMsg.textContent = "No checkpoints in this gamemode";
    checkpointsMenu.appendChild(noCheckpointMsg);
    progressBar.style.width = "34%"; //MAJ PROGRESS BAR
    ///////////////////////////////////////// CREATE TREES
    var box_tree = BABYLON.MeshBuilder.CreateCylinder("box_tree", { diameter: 1.5, height: 12.5}, scene);
    box_tree.isVisible = false;
    var treePositions = [
        {position: new BABYLON.Vector3(2, 0, 18), rotation: 0, i: 1 },
        { position: new BABYLON.Vector3(-7, 0, 15), rotation: 0, i: 2 },
        { position: new BABYLON.Vector3(17, 0, 4), rotation: Math.PI / 4, i: 3 },
   ];
    var trees = [(await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "tree1.glb", scene)).meshes[0], (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "tree2.glb", scene)).meshes[0], (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "tree3.glb", scene)).meshes[0], (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "tree4.glb", scene)).meshes[0], (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "tree5.glb", scene)).meshes[0]];
    treePositions.forEach((treePosition, index) => {
        let tree = trees[treePosition.i - 1].clone("tree" + index);
    ...
    var lampPositions = [
        { position: new BABYLON.Vector3(-10.073, 0, -7.731), rotation: 0 },
        { position: new BABYLON.Vector3(100,1000,100), rotation: 0 }
    ];
    var lamp = (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "lamp.glb", scene)).meshes[0];
    lamp.scaling = new BABYLON.Vector3(1,1.2,1);
    lamp.rotationQuaternion = false;
    ...
    glowLayerCone.intensity = 0.15;
    glowLayerCone.blurKernelSize = 64;
    var highlightLayerCheckpoint = new BABYLON.HighlightLayer("highlight", scene);
    lampPositions.forEach((lampPosition, index) => {
        let lampClone = lamp.clone("Lamp" + index);
        lampClone.position = lampPosition.position;
        lampClone.rotation.y = lampPosition.rotation;
    ...
    var benchPositions = [
        { position: new BABYLON.Vector3(-16,0,-8), rotationQ: -96 },
        { position: new BABYLON.Vector3(89,1000,105), rotationQ: 0 },
    ];
    var bench = (await BABYLON.SceneLoader.ImportMeshAsync("", "./models/", "bench.glb", scene)).meshes[0];
    bench.rotationQuaternion = null;
    benchPositions.forEach((benchPosition, index) => {
    ...
    artefact.rotation.x = Math.PI / 2;
    var artefactPositions = [ 
        { position: new BABYLON.Vector3(6 ,100,5), color: "#FF0000" }, 
        { position: new BABYLON.Vector3(5,200,-5), color: "#FFA500" }, 
        { position: new BABYLON.Vector3(5,300,10.3), color: "#FFFF00" }, 
        { position: new BABYLON.Vector3(-8,400,-8), color: "#7FFF00" }, 
        { position: new BABYLON.Vector3(-3,500,13), color: "#00FF00" }, 
        { position: new BABYLON.Vector3(-5, 600, 11), color: "#00FF7F" }, 
        { position: new BABYLON.Vector3(3,700,7), color: "#00FFFF" }, 
        { position: new BABYLON.Vector3(21,800,-38), color: "#007FFF" }, 
        { position: new BABYLON.Vector3(7,900,-16), color: "#0000FF" }, 
        { position: new BABYLON.Vector3(103,1002,110), color: "#8B00FF" }, 
        { position: new BABYLON.Vector3(100,1002,92), color: "#FF00FF" }, 
        { position: new BABYLON.Vector3(110, 1002, 102), color: "#FFC0CB" }
    ];
    const glowLayerArtefact = new BABYLON.GlowLayer("glow", scene);
    glowLayerArtefact.intensity = 3;
    var allFound = 0;
                ...
                scene.beginAnimation(artefactClone, 0, 30, false, 1, () => {
                    ...
                    setTimeout(() => {
                        if(!portalCreated){
                            ...
                            bridgePortalMeshes.forEach(mesh => {
                                mesh.animations = [animY, animFade];
                                scene.beginAnimation(mesh, 0, 15, false,0.25, () => {
                                    setTimeout(() => {
                                        camera_anim.fov = 1.2;
                                        camera_anim.radius = 50;
                                        camera_anim.lockedTarget = planePortal;
    ...
    progressBar.style.width = "79%"; //MAJ PROGRESS BAR
    createInvisParkour(scene, [
        new BABYLON.Vector3(32, 47, 21),
        new BABYLON.Vector3(35, 50, 23),
        new BABYLON.Vector3(38, 53, 25),
        new BABYLON.Vector3(41, 56, 27),
        new BABYLON.Vector3(44, 59, 29),
        new BABYLON.Vector3(47, 62, 31),
        new BABYLON.Vector3(50, 65, 33),
    ], new BABYLON.Vector3(30, 45, 19), 8000);
    const start = new BABYLON.Vector3(6, 98, 5);
    const end = new BABYLON.Vector3(5, 198, -5);
    const invis1 = [
        new BABYLON.Vector3(8, 101, 5),
        new BABYLON.Vector3(9, 104, 2),
        new BABYLON.Vector3(6, 107, -1),
        new BABYLON.Vector3(6, 110, -4),
        new BABYLON.Vector3(5, 113, -5),
        new BABYLON.Vector3(5, 116, -6),
    ];
    createInvisParkour(scene, invis1, start, invis1.length * 1500);
    createMovParkour(scene, [
        {
            position: new BABYLON.Vector3(5, 119, -5),
            direction: new BABYLON.Vector3(0, 0, -6),
            speed: 1.5
        },
    ]);
    createLaserParkour(scene,
        [new BABYLON.Vector3(5, 122, -8),new BABYLON.Vector3(5, 125.5, -15)], 
        [{
            position: new BABYLON.Vector3(5, 123, -8),
            direction: new BABYLON.Vector3(4, 0, 0),
            axis: "x",
            speed: 1
        }]
    );
    const invis2 = [
        new BABYLON.Vector3(5, 126, -8),
        new BABYLON.Vector3(5, 129, -8),
        new BABYLON.Vector3(5, 132, -7),
        new BABYLON.Vector3(5, 135, -6),
        new BABYLON.Vector3(5, 138, -7),
        new BABYLON.Vector3(5, 141, -5),
        new BABYLON.Vector3(5, 144, -7),
        new BABYLON.Vector3(5, 147, -5),
        new BABYLON.Vector3(5, 150, -7),
        new BABYLON.Vector3(5, 153, -9),
        new BABYLON.Vector3(5, 156, -7),
        new BABYLON.Vector3(6, 159, -5),
        new BABYLON.Vector3(8, 162, -5),
        new BABYLON.Vector3(5, 165, -7),
        new BABYLON.Vector3(8, 168, -7),
        new BABYLON.Vector3(6, 171, -5),
        new BABYLON.Vector3(8, 174, -5),
        new BABYLON.Vector3(9, 177, -5),
        new BABYLON.Vector3(8, 180, -7),
        new BABYLON.Vector3(5, 183, -7),
        new BABYLON.Vector3(2, 186, -2),
        new BABYLON.Vector3(5, 189, -5),
        new BABYLON.Vector3(8, 192, -5),
        new BABYLON.Vector3(10, 195, -5),
    ];
    createInvisParkour(scene, invis2, new BABYLON.Vector3(5, 126, -15), invis2.length * 2000);
    //2
    const invis3 = [
        new BABYLON.Vector3(5, 201, -8),
        new BABYLON.Vector3(3, 203, -5),
        new BABYLON.Vector3(7, 207, -3),
        new BABYLON.Vector3(9, 211, 0),
        new BABYLON.Vector3(6, 215, 2),
        new BABYLON.Vector3(5, 219, 4),
    ];
    createInvisParkour(scene, invis3, new BABYLON.Vector3(5, 198.5, -5), invis3.length * 2000);
    createMovParkour(scene, [
        {
            position: new BABYLON.Vector3(5, 222, 4),
            direction: new BABYLON.Vector3(0, 0, 10), 
            speed: 3
        },
        {
            position: new BABYLON.Vector3(5, 222, 14),
            direction: new BABYLON.Vector3(6, 2, 0),  
            speed: 3
        },
    ]);
    createLaserParkour(scene,
        [new BABYLON.Vector3(5, 225, 20),new BABYLON.Vector3(10, 229, 20), new BABYLON.Vector3(15, 232, 19), new BABYLON.Vector3(16, 236, 18), new BABYLON.Vector3(16, 238, 20)],
        [
            {
                position: new BABYLON.Vector3(14, 234, 20),
                direction: new BABYLON.Vector3(-6, 0, 0),
                axis: "x",
                speed: 0
            }
        ]
    ...
    const invis4 = [
        new BABYLON.Vector3(13, 240, 19),
        new BABYLON.Vector3(11, 244, 17),
        new BABYLON.Vector3(9, 248, 15),
        new BABYLON.Vector3(7, 252, 13),
        new BABYLON.Vector3(5, 256, 11),
        new BABYLON.Vector3(5, 260, 13),
        new BABYLON.Vector3(5, 264, 15),
        new BABYLON.Vector3(5, 268, 17),
        new BABYLON.Vector3(5, 272, 19),
    ];
    createInvisParkour(scene, invis4, new BABYLON.Vector3(16, 238.5, 20), invis4.length * 1500);
    createMovParkour(scene, [
        {
            position: new BABYLON.Vector3(7, 272, 20),
            direction: new BABYLON.Vector3(0, 4, 0), 
            speed: 5
        },
        {
            position: new BABYLON.Vector3(5, 278, 19),
            direction: new BABYLON.Vector3(0, 12, 0), 
            speed: 2.5
        },
        {
            position: new BABYLON.Vector3(5, 286, 19),
            direction: new BABYLON.Vector3(0, 14, 0),  
            speed: 2.5
        },
    ]);
    //3
    const invis5 = [
        new BABYLON.Vector3(6, 301, 15),
        new BABYLON.Vector3(7, 304, 12),
        new BABYLON.Vector3(7, 306, 9),
        new BABYLON.Vector3(6, 309, 6),
        new BABYLON.Vector3(4, 312, 3),
        new BABYLON.Vector3(5, 315, 0),
        new BABYLON.Vector3(7, 318, -2),
    ];
    createInvisParkour(scene, invis5, new BABYLON.Vector3(5, 300, 10.3), invis5.length * 2000);
    createMovParkour(scene, [
        {
            position: new BABYLON.Vector3(7, 321, -2),
            direction: new BABYLON.Vector3(8, 0, 0),
            speed: 2.5
        },
        {
            position: new BABYLON.Vector3(15, 321, -2),
            direction: new BABYLON.Vector3(0, 3, -6),
            speed: 2.5
        },
    ]);
    createLaserParkour(scene,
        [
            new BABYLON.Vector3(15, 324, -8),
            new BABYLON.Vector3(13, 328, -10),
            new BABYLON.Vector3(10, 332, -11),
            new BABYLON.Vector3(7, 336, -12),
            new BABYLON.Vector3(5, 340, -12)
        ],
        [
            {
                position: new BABYLON.Vector3(7, 336, -12),
                direction: new BABYLON.Vector3(0, 3, 0),
                axis: "y",
                speed: 1.5
            }
        ]
    ...
    const invis6 = [
        new BABYLON.Vector3(5, 343, -12),
        new BABYLON.Vector3(3, 346, -11),
        new BABYLON.Vector3(0, 349, -10),
        new BABYLON.Vector3(-3, 352, -9),
        new BABYLON.Vector3(-6, 355, -8),
        new BABYLON.Vector3(-7, 358, -8),
        new BABYLON.Vector3(-8, 361, -8),
    ];
    createInvisParkour(scene, invis6, new BABYLON.Vector3(5, 340, -12), invis6.length * 1500);
    createMovParkour(scene, [
        {
            position: new BABYLON.Vector3(-8, 370, -8),
            direction: new BABYLON.Vector3(0, 16, 0),
            speed: 6
        },
        {
            position: new BABYLON.Vector3(-10, 383, -8),
            direction: new BABYLON.Vector3(0, 18, 0),
            speed: 6
        },
    ]);
    //4
    createLaserParkour(scene,
        [
            new BABYLON.Vector3(-8,398,-5),
            new BABYLON.Vector3(-8,401,-3),
            new BABYLON.Vector3(-8,404,-1),
            new BABYLON.Vector3(-8,407,1),
            new BABYLON.Vector3(-8,410,3),
            new BABYLON.Vector3(-8,413,5),
            new BABYLON.Vector3(-8,416,7),
            new BABYLON.Vector3(-8,419,9),
            new BABYLON.Vector3(-8,422,11),
            new BABYLON.Vector3(-8,425,13),
            new BABYLON.Vector3(-5,428,13),
            new BABYLON.Vector3(-2,431,13),
            new BABYLON.Vector3(1,434,13),
            new BABYLON.Vector3(4,437,13),
            new BABYLON.Vector3(7,440,13),
            new BABYLON.Vector3(10,443,13),
            new BABYLON.Vector3(10,446,10),
            new BABYLON.Vector3(10,449,7),
            new BABYLON.Vector3(10,452,4),
            new BABYLON.Vector3(10,455,1),
            new BABYLON.Vector3(10,458,-2),
            new BABYLON.Vector3(10,461,-5),
            new BABYLON.Vector3(10,464,-8),
            new BABYLON.Vector3(8,467,-6),
            new BABYLON.Vector3(6,470,-4),
            new BABYLON.Vector3(4,473,-2),
            new BABYLON.Vector3(2,476,0),
            new BABYLON.Vector3(0,479,2),
            new BABYLON.Vector3(-2,482,4),
            new BABYLON.Vector3(-4,485,6),
            new BABYLON.Vector3(-6,488,8),
            new BABYLON.Vector3(-8,491,10),
            new BABYLON.Vector3(-10,494,12),
            new BABYLON.Vector3(-6,497,13),
        ],
        [
            {position: new BABYLON.Vector3(-8,408.5,0),direction: new BABYLON.Vector3(10, 0, 0),axis: "x",speed: 5},
            {position: new BABYLON.Vector3(-8,411.5,2),direction: new BABYLON.Vector3(-10, 0, 0),axis: "x",speed: 5},
            {position: new BABYLON.Vector3(-8,414.5,4),direction: new BABYLON.Vector3(10, 0, 0),axis: "x",speed: 5},
            {position: new BABYLON.Vector3(-8,420.5,8),direction: new BABYLON.Vector3(10, 0, 0),axis: "x",speed: 5},
            {position: new BABYLON.Vector3(-8,423.5,10),direction: new BABYLON.Vector3(-10, 0, 0),axis: "x",speed: 5},
            {position: new BABYLON.Vector3(-5,429,13),direction: new BABYLON.Vector3(11, 13, 0),axis: "z",speed: 2},

        ]
    );
    //5
    const invis7 = [
        new BABYLON.Vector3(-6, 500, 13),
        new BABYLON.Vector3(-8, 503, 11),
        new BABYLON.Vector3(-10, 506, 9),
        new BABYLON.Vector3(-12, 509, 7),
        new BABYLON.Vector3(-14, 512, 5),
        new BABYLON.Vector3(-16, 515, 3),
        new BABYLON.Vector3(-18, 518, 1),
        new BABYLON.Vector3(-20, 521, -1),
        new BABYLON.Vector3(-22, 524, -3),
        new BABYLON.Vector3(-24, 527, -5),
        new BABYLON.Vector3(-26, 530, -7),
        new BABYLON.Vector3(-28, 533, -7),
        new BABYLON.Vector3(-26, 536, -7),
        new BABYLON.Vector3(-28, 539, -7),
        new BABYLON.Vector3(-26, 542, -7),
        new BABYLON.Vector3(-28, 545, -7),
        new BABYLON.Vector3(-26, 548, -7),
        new BABYLON.Vector3(-28, 551, -7),
        new BABYLON.Vector3(-26, 554, -7),
        new BABYLON.Vector3(-28, 557, -7),
        new BABYLON.Vector3(-26, 560, -7),
        new BABYLON.Vector3(-28, 563, -7),
        new BABYLON.Vector3(-26, 566, -7),
        new BABYLON.Vector3(-28, 569, -7),
        new BABYLON.Vector3(-26, 572, -7),
        new BABYLON.Vector3(-28, 575, -7),
        new BABYLON.Vector3(-26, 578, -7),
        new BABYLON.Vector3(-28, 581, -7),
        new BABYLON.Vector3(-26, 584, -7),
        new BABYLON.Vector3(-28, 587, -7),
        new BABYLON.Vector3(-26, 590, -4),
        new BABYLON.Vector3(-24, 593, -2),
        new BABYLON.Vector3(-22, 596, 0),
        new BABYLON.Vector3(-20, 599, 2),
        new BABYLON.Vector3(-16, 600, 4),
        new BABYLON.Vector3(-12, 603, 6),
    ];
    createInvisParkour(scene, invis7, new BABYLON.Vector3(-3, 498.5, 13), invis7.length * 1250);
    //6 
    createLaserParkour(scene,
        [
            new BABYLON.Vector3(-5, 600, 8),new BABYLON.Vector3(-5, 603, -3), new BABYLON.Vector3(-5, 606, -14), 
            new BABYLON.Vector3(-5, 609, -3), new BABYLON.Vector3(-5, 612, 8), new BABYLON.Vector3(-5, 615, -3),
            new BABYLON.Vector3(-5, 618, -14), new BABYLON.Vector3(-5, 621, -3), new BABYLON.Vector3(-5, 624, 8),
            new BABYLON.Vector3(-5, 627, -3), new BABYLON.Vector3(-5, 630, -14), new BABYLON.Vector3(-5, 633, -3),
            new BABYLON.Vector3(-5, 636, 8), new BABYLON.Vector3(-5, 639, -3), new BABYLON.Vector3(-5, 642, -14),
            new BABYLON.Vector3(-5, 645, -3), new BABYLON.Vector3(-5, 648, 8), new BABYLON.Vector3(-5, 651, -3),
            new BABYLON.Vector3(-5, 654, -14), new BABYLON.Vector3(-5, 657, -3), new BABYLON.Vector3(-5, 660, 8),
            new BABYLON.Vector3(-5, 663, -3), new BABYLON.Vector3(-5, 666, -14), new BABYLON.Vector3(-5, 669, -3),
            new BABYLON.Vector3(-5, 672, 8), new BABYLON.Vector3(-5, 675, -3), new BABYLON.Vector3(-5, 678, -14),
            new BABYLON.Vector3(-5, 681, -3), new BABYLON.Vector3(-5, 684, 8), new BABYLON.Vector3(-5, 687, -3),
            new BABYLON.Vector3(-5, 690, -14), new BABYLON.Vector3(-5, 693, -3), new BABYLON.Vector3(-5, 696, 8),
        ],  
        [
            { position: new BABYLON.Vector3(-5, 600, 2), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:10 },
            { position: new BABYLON.Vector3(-5, 603, 2), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:12 },
            { position: new BABYLON.Vector3(-5, 606, 2), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:8 },
            { position: new BABYLON.Vector3(-5, 609, 2), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:6 },
            { position: new BABYLON.Vector3(-5, 600, -9), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:10 },
            { position: new BABYLON.Vector3(-5, 603, -9), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:12 },
            { position: new BABYLON.Vector3(-5, 606, -9), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:8 },
            { position: new BABYLON.Vector3(-5, 609, -9), direction: new BABYLON.Vector3(0, 80, 0), axis: "x", speed:6 },
        ]
    );
    //7 
    let invis7StartY = 700;
    let invis7EndY = 800;
    let invis7Platforms = [];
    for (let i = 0; i <= (invis7EndY - invis7StartY); i += 2) {
        invis7Platforms.push(new BABYLON.Vector3(8 + (i * 0.5), invis7StartY + i, 7));
    }
    createInvisParkour(scene, invis7Platforms, new BABYLON.Vector3(3, 698, 7), 3000);
    createLaserParkour(scene,
        [
            new BABYLON.Vector3(58, 800, 7)
        ],[
            { position: new BABYLON.Vector3(13, 712, 7), direction: new BABYLON.Vector3(0, 0, -3), axis: "x", speed: 3 },
            { position: new BABYLON.Vector3(23, 732, 7), direction: new BABYLON.Vector3(0, 0, 3), axis: "x", speed: 3 },
            { position: new BABYLON.Vector3(33, 752, 7), direction: new BABYLON.Vector3(0, 0, -3), axis: "x", speed: 3 },
            { position: new BABYLON.Vector3(43, 772, 7), direction: new BABYLON.Vector3(0, 0, -3), axis: "x", speed: 3 },
            { position: new BABYLON.Vector3(53, 792, 7), direction: new BABYLON.Vector3(0, 0, 3), axis: "x", speed: 3 },
        ]    
    );
    createInvisParkour(scene, [
        new BABYLON.Vector3(50, 800, 5),new BABYLON.Vector3(42, 800, 3), new BABYLON.Vector3(34, 800, 1),
        new BABYLON.Vector3(26, 800, -1), new BABYLON.Vector3(21, 800, -3),new BABYLON.Vector3(10, 800, -14),
         new BABYLON.Vector3(10, 800, -25)
    ], new BABYLON.Vector3(58, 800.5, 7), 10000);
    //8
    createMovParkour(scene, [
        {position: new BABYLON.Vector3(21, 800, -42),direction: new BABYLON.Vector3(0, 30, 0),speed: 6},
        {position: new BABYLON.Vector3(21, 860, -38),direction: new BABYLON.Vector3(0, -30, 0),speed: 6},
        {position: new BABYLON.Vector3(21, 860, -34),direction: new BABYLON.Vector3(0, 30, 0),speed: 6},
        {position: new BABYLON.Vector3(21, 920, -30),direction: new BABYLON.Vector3(0, -30, 0),speed: 6},
        //1
        {position: new BABYLON.Vector3(80, 90, 52), direction: new BABYLON.Vector3(-80, 10, -52),speed: 8},
    ]);
    createLaserParkour(scene,
        [
            new BABYLON.Vector3(21, 800, -42), new BABYLON.Vector3(21, 830, -38), new BABYLON.Vector3(21, 860, -34),
            new BABYLON.Vector3(21, 890, -30), new BABYLON.Vector3(21, 920, -26)
        ],[
            { position: new BABYLON.Vector3(20, 810, -42), direction: new BABYLON.Vector3(0, 0, -10), axis: "z", speed: 0 },
            { position: new BABYLON.Vector3(21, 820, -41), direction: new BABYLON.Vector3(0, 0, 10), axis: "x", speed: 0 },
            { position: new BABYLON.Vector3(22, 830, -42), direction: new BABYLON.Vector3(0, 0, -10), axis: "z", speed: 0 },
            
            { position: new BABYLON.Vector3(22, 840, -38), direction: new BABYLON.Vector3(0, 0, -10), axis: "z", speed: 0 },
            { position: new BABYLON.Vector3(20, 850, -38), direction: new BABYLON.Vector3(0, 0, 10), axis: "z", speed: 0 },
            { position: new BABYLON.Vector3(22, 860, -38), direction: new BABYLON.Vector3(0, 0, -10), axis: "z", speed: 0 },

            { position: new BABYLON.Vector3(20, 870, -34), direction: new BABYLON.Vector3(0, 0, 10), axis: "z", speed: 0 },
            { position: new BABYLON.Vector3(21, 880, -33), direction: new BABYLON.Vector3(0, 0, -10), axis: "x", speed: 0 },
            { position: new BABYLON.Vector3(21, 890, -35), direction: new BABYLON.Vector3(0, 0, 10), axis: "x", speed: 0 },

            { position: new BABYLON.Vector3(22, 900, -30), direction: new BABYLON.Vector3(0, 0, -10), axis: "z", speed: 0 },
            { position: new BABYLON.Vector3(20, 910, -30), direction: new BABYLON.Vector3(0, 0, 10), axis: "z", speed: 0 },
            { position: new BABYLON.Vector3(21, 920, -31), direction: new BABYLON.Vector3(0, 0, -10), axis: "x", speed: 0 },

            //9  { position: new BABYLON.Vector3(79.5,940,92.5), scale: 0.1 }
            { position: new BABYLON.Vector3(85,935,92), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,940,93), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,945,94), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,950,95), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,955,96), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,960,97), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,965,98), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,970,99), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,975,100), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,980,101), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,985,102), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
            { position: new BABYLON.Vector3(85,990,103), direction: new BABYLON.Vector3(0, 10, 0), axis: "y", speed: 0 },
        ]    
    );
    ...
    volume.addEventListener('input', function() {
        ...
        if(!mute.classList.contains("on")){
            ...
            errorSound.setVolume(0.014*volume.value);
            magicIdleSound.setVolume(0.001*volume.value);
            magicIdleSound2.setVolume(0.01*volume.value);
            magicalsEffectsSound.setVolume(0.01*volume.value);
            fallSound.setVolume(0.05*volume.value);
            looseSound.setVolume(0.005*volume.value);
        }
